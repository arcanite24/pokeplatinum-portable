...
static void ov115_02263DF8(UnkStruct_ov115_02263DF8 *param0, NARC *param1, u32 heapID, NNSFndAllocator *param3)
{
    ...
    for (v2 = 0; v2 < 6; v2++) {
        ...
        #else
        // TODO: Port NNS_G3dGetNodeInfo to PAL
        #endif

        #ifdef PLATFORM_DS
        while ((v6 = NNS_G3dGetNodeNameByIdx(v7, v3)) != NULL) {
        #else
        // TODO: Port NNS_G3dGetNodeNameByIdx to PAL
        #endif
            #ifdef PLATFORM_DS
        ...
        for (v3 = 0; v3 < 15; v3++) {
            ...
            #else
            // TODO: Port NNS_G3dGetNodeIdxByName to PAL
            #endif
            ...
            if (v5 != -1) {
                ...
                #else
                // TODO: Port NNS_G3dAnmObjEnableID to PAL
                #endif
            }
        }
    }
